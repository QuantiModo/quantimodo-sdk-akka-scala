...
object MeasurementsApi {
   ...
   * 
   * Expected answers:
   *   code 401 : Seq[MeasurementSource] (Not Authenticated)
   */
  def measurementSourcesGet(): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.GET, "https://localhost/api", "/measurementSources", "application/json")
      .withErrorResponse[Seq[MeasurementSource]](401)
   ...
   */
  def measurementSourcesPost(name: Seq[MeasurementSource]): ApiRequest[Unit] =
   ...
   * 
   * Expected answers:
   *   code 401 : Seq[Measurement] (Not Authenticated)
   * 
   ...
   */
  def measurementsGet(variableName: String, unit: Option[String] = None, startTime: Option[String] = None, endTime: Option[String] = None, groupingWidth: Option[Int] = None, groupingTimezone: Option[String] = None): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.GET, "https://localhost/api", "/measurements", "application/json")
      ...
      .withErrorResponse[Seq[Measurement]](401)
   ...
   */
  def measurementsV2Post(measurements: Seq[Measurement]): ApiRequest[Unit] =
   ...
   * 
   * Expected answers:
   *   code 401 : Seq[MeasurementRange] (Not Authenticated)
   * 
   ...
   */
  def measurementsRangeGet(sources: Option[String] = None, user: Option[Int] = None): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.GET, "https://localhost/api", "/measurementsRange", "application/json")
      .withQueryParam("sources", sources)
      .withQueryParam("user", user)
      .withErrorResponse[Seq[MeasurementRange]](401)
