...
object VariablesApi {
   ...
   *   code 401 :  (Not Authenticated)
   */
  def publicVariablesGet(): ApiRequest[Variable] =
    ApiRequest[Variable](ApiMethods.GET, "https://localhost/api", "/public/variables", "application/json")
   ...
   */
  def publicVariablesSearchSearchGet(search: String, effectOrCause: Option[String] = None): ApiRequest[Variable] =
    ApiRequest[Variable](ApiMethods.GET, "https://localhost/api", "/public/variables/search/{search}", "application/json")
   ...
   *   code 401 :  (Not Authenticated)
   */
  def variableCategoriesGet(): ApiRequest[Seq[VariableCategory]] =
    ApiRequest[Seq[VariableCategory]](ApiMethods.GET, "https://localhost/api", "/variableCategories", "application/json")
   ...
   */
  def variableUserSettingsPost(sharingData: VariableUserSettings): ApiRequest[Unit] =
   ...
   */
  def variablesGet(userId: Option[Int] = None, categoryName: Option[String] = None)(implicit basicAuth: BasicCredentials): ApiRequest[Variable] =
    ApiRequest[Variable](ApiMethods.GET, "https://localhost/api", "/variables", "application/json")
   ...
   */
  def variablesPost(variableName: VariablesNew): ApiRequest[Unit] =
   ...
   */
  def variablesSearchSearchGet(search: String, categoryName: Option[String] = None, source: Option[String] = None, limit: Option[Int] = None, offset: Option[Int] = None): ApiRequest[Seq[Variable]] =
    ApiRequest[Seq[Variable]](ApiMethods.GET, "https://localhost/api", "/variables/search/{search}", "application/json")
      .withQueryParam("categoryName", categoryName)
   ...
   */
  def variablesVariableNameGet(variableName: String): ApiRequest[Variable] =
    ApiRequest[Variable](ApiMethods.GET, "https://localhost/api", "/variables/{variableName}", "application/json")
